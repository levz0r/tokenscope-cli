...
export function ApiKeySection({ apiKey, lastUsedAt }: ApiKeySectionProps) {
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-xs text-gray-600">
              Last used: <span className={lastUsedAt ? 'text-gray-400' : 'text-gray-600'}>{formatLastUsed(lastUsedAt)}</span>
            </p>
          </div>
          <Button
            variant="outline"
