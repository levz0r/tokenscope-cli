...
interface CreateTeamInOrgButtonProps {
  orgId: string
  variant?: 'default' | 'large'
}

export function CreateTeamInOrgButton({ orgId, variant = 'default' }: CreateTeamInOrgButtonProps) {
        ...
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-400">
              Create a team within this organization. You&apos;ll be the team owner.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4">
